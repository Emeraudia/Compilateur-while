...
public class WhileLexer extends Lexer {
  ...
  public final void mT__30() throws RecognitionException {
    try {
      int _type = T__30;
      int _channel = DEFAULT_TOKEN_CHANNEL;
      // /home/caeles/Documents/Cours/ESIR2/TLC/Projet/grammaire/While.g:10:7: (
      // 'cons' )
  ...
  public final void mT__32() throws RecognitionException {
    try {
      int _type = T__32;
      int _channel = DEFAULT_TOKEN_CHANNEL;
      // /home/caeles/Documents/Cours/ESIR2/TLC/Projet/grammaire/While.g:12:7: (
      // 'else' )
  ...
  public final void mT__45() throws RecognitionException {
    try {
      int _type = T__45;
      int _channel = DEFAULT_TOKEN_CHANNEL;
      // /home/caeles/Documents/Cours/ESIR2/TLC/Projet/grammaire/While.g:25:7: (
      // 'then' )
  ...
  public final void mVARIABLE() throws RecognitionException {
    try {
      int _type = VARIABLE;
      int _channel = DEFAULT_TOKEN_CHANNEL;
      // /home/caeles/Documents/Cours/ESIR2/TLC/Projet/grammaire/While.g:30:10: ( (
      // 'A' .. 'Z' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )* ( '!' | '?' )? )
      // /home/caeles/Documents/Cours/ESIR2/TLC/Projet/grammaire/While.g:30:13: ( 'A'
      // .. 'Z' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )* ( '!' | '?' )?
      {
        ...
        // /home/caeles/Documents/Cours/ESIR2/TLC/Projet/grammaire/While.g:30:23: ( 'A'
        // .. 'Z' | 'a' .. 'z' | '0' .. '9' )*
        loop1: while (true) {
          int alt1 = 2;
  ...
  public final void mSYMBOL() throws RecognitionException {
    try {
      int _type = SYMBOL;
      int _channel = DEFAULT_TOKEN_CHANNEL;
      // /home/caeles/Documents/Cours/ESIR2/TLC/Projet/grammaire/While.g:32:8: ( ( 'a'
      // .. 'z' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )* ( '!' | '?' )? )
      // /home/caeles/Documents/Cours/ESIR2/TLC/Projet/grammaire/While.g:32:11: ( 'a'
      // .. 'z' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' )* ( '!' | '?' )?
      {
        if ((input.LA(1) >= 'a' && input.LA(1) <= 'z')) {
          input.consume();
        ...
        // /home/caeles/Documents/Cours/ESIR2/TLC/Projet/grammaire/While.g:32:21: ( 'A'
        // .. 'Z' | 'a' .. 'z' | '0' .. '9' )*
        loop3: while (true) {
          int alt3 = 2;
